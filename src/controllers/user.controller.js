...
signUp = (request, response, next) => {
    ...
    const {
        error
    } = registerSchema.validate(request.body);
    if (error) {
    ...
    /* End Validating the request */
        ...
        const text = 'INSERT INTO _tblSuperSurveyUsers(email_id,password,created_at,updated_at,last_login) VALUES($1, $2,$3,$4,$5)'
        ...
        client.query(text, values, (err, result) => {
            if (err) {
                ...
                response.status(200).json({
                    code: 200,
                    message: 'Registered Successfully..,Please Check your email inbox to verify.'
                })
